...
public class BankMain extends javax.swing.JFrame {
    ...
    private void jMenuItem1ActionPerformed(ActionEvent evt) {
        ...
        num = Integer.parseInt(JOptionPane.showInputDialog(null, "Please Enter Account Holder Number:", "Create Account", 1));
        acc = new Account(name, num);
        JOptionPane.showMessageDialog(null, "Account Succesfully Created!", "Create Account", 1);
    }

    private void jButton6ActionPerformed(ActionEvent evt) {
        JOptionPane.showMessageDialog(null,"Created By PRATEEKSONI", "About", 1);
    }
    ...
    private void jMenuItem4ActionPerformed(ActionEvent evt) {
    	...
    	if(acc != null) {
    		...
    		JOptionPane.showMessageDialog(null,str, "About", 1);
    	}
    	else
    		JOptionPane.showMessageDialog(null,"Create user first.", "About", 1);
